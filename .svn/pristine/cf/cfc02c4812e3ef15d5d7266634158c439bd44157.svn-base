...
/**
 * Main class that initializes the server and other threads.
 * @author gokul.
 *
 */
public class P2PCache {
	...
	/**
	 * prints the name and SEAS Login
	 */
	private static void printUserNameInfo() {
		System.out.println("Name : GOKUL KRISHNAN RAGUNATHAN");
		System.out.println("SEAS Name : grag");		
	}
